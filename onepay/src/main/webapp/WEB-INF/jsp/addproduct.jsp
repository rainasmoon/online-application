...
<h1>添加一个商品</h1>
<form:form modelAttribute="product" method="post" action="/addproduct.html"
...
<%-- 			</canvas> --%>
		...
		<div>
			<label for="inputAging">新旧程度</label> <label class="radio-inline">
				...
				name="aging" value="3" />3
			</label> <label class="radio-inline"> <input type="radio"
				name="aging" value="4" />4
			</label> <label class="radio-inline"> <input type="radio"
				name="aging" value="5" />5
			</label> <label class="radio-inline"> <input type="radio"
				name="aging" value="6" />6
			</label> <label class="radio-inline"> <input type="radio"
				name="aging" value="7" />7
			</label> <label class="radio-inline"> <input type="radio"
				name="aging" value="8" />8
			</label> <label class="radio-inline"> <input type="radio"
				name="aging" value="9" />9
			</label><label class="radio-inline"> <input type="radio" name="aging"
				value="10" />10
			</label>
		</div>
		<hr />
