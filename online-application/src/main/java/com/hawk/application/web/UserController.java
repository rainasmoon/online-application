...
public class UserController {
	...
	public String processCreationForm(@Valid RegistorVo registorVo, BindingResult result) {
	...
	public String initPersonalInformationForm(HttpSession session, Map<String, Object> model) {
		String userEmail = (String) session.getAttribute("userEmail");
		User user = userService.findUserByEmail(userEmail);		
		model.put("user", user);
